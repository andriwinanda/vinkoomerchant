<template>
  <div>
    <f7-navbar back-link no-hairline padding no-shadow>
      <f7-searchbar
        no-hairline
      ...
      <div v-if="bagTemp.item" class="sheet-modal-swipe-step">
        ...
        >
          ...
          <div>
            <f7-stepper
              :value="
                bagTemp.item.qty >= bagTemp.qty ? bagTemp.qty : bagTemp.item.qty
              "
        ...
        >
          ...
          <div>
            <b style="font-size: 22px" class="text-color-primary">
              Rp {{ numeric(bagTemp.item.price * bagTemp.qty) }}
            </b>
          </div>
        </div>
        <div class="padding-horizontal padding-bottom">
          <f7-row>
            <f7-col>
              <f7-button large outline :disabled="!bagTemp.item.qty"
                >Checkout</f7-button
              >
            </f7-col>
            <f7-col>
...
export default {
  ...
  methods: {
    ...
    pay() {
      f7.dialog.prompt("Input customer number", (name) => {
        f7.dialog.confirm(
          "Are you sure that your customer number is " + name + "?",
          () => {
            f7.dialog.alert("Bill sent");
            this.bagSheet = false;
          }
        );
      });
